...
const ar: Dict = {
  ...
  'section.feedWatcher.subtitle': 'يتصفّح موجزك تلقائيًا ويلتقط لك المنشورات التي تستحقّ ردًّا',
  'section.contentEngine.title': 'محرّك المحتوى',
  'section.contentEngine.subtitle': 'اكتب منشورات وردودًا مقنعة تجذب عملاءك',
  'section.voiceStudio.title': 'استوديو النبرة',
  'section.voiceStudio.subtitle': 'اضبط أسلوب كتابتك مرّة واحدة، فتخرج كل منشوراتك بالنبرة نفسها.',
  ...
  'dash.step.watch.desc': 'يلتقط لك تلقائيًا من موجزك المنشورات التي يظهر فيها اهتمام بالشراء.',
  ...
  'fw.title': 'تشغيل تلقائي في الخلفية',
  'fw.subtitle': 'يعمل داخل الإضافة — حتى عندما تكون هذه الصفحة مغلقة.',
  'fw.active': 'نشط',
  'fw.off': 'متوقّف',
  'fw.intro': 'فعّل المنصّات في الأسفل. كل {interval} دقيقة يفتح الوكيل نافذة خفيّة ويتصفّح موجزك تمامًا كما يفعل الإنسان، حتى يجمع {max} منشورًا أو تنتهي المنشورات الجديدة. ثم يُقيّم الذكاء الاصطناعي كل منشور وفق وصفك، وما بلغت ملاءمته {min}/100 أو أكثر يظهر في «متتبّع المنشورات». لا يُقيَّم المنشور مرّتين، وتُقرأ بيانات صاحبه من الموجز مباشرة دون فتح ملفه الشخصي.',
  ...
  'fw.maxPosts.helper': 'كم منشورًا يُسحب إلى متتبّع المنشورات في كل فحص (1–100). الأرقام الأعلى تُمرّر الموجز مدّة أطول — قد يستغرق فحص 100 منشور عدّة دقائق من التمرير المرئي.',
  ...
  'fw.poll.helper': 'الحدّ الأدنى دقيقتان، والأقصى 6 ساعات. يُمرّر كل فحص كل موجز مُفعّل حتى يبلغ حدّ «العدد الأقصى للمنشورات في كل فحص» أو تنفد المنشورات الجديدة.',
  'fw.stat.buffer': 'في آخر تصفّح للموجز',
  ...
  'vs.voices': 'النبرات',
  'vs.noVoices': 'لا نبرات محفوظة بعد — اضبط المؤشّرات أدناه واحفظ نبرة في الأسفل.',
  'vs.newVoice': 'نبرة جديدة',
  'vs.steal.title': 'انسخ نبرة',
  ...
  'vs.steal.body': 'أدرِج معرّف X / Twitter — يفتح الوكيل ملفهم، ويقرأ أحدث تغريداتهم الأصلية، ويبني الذكاء الاصطناعي تلقائيًا ملف نبرتك كاملًا أدناه: مؤشّرات السمات السبع، والإيقاع، وصيغة المَطلع، والمضخّمات، والخاتمة، وحتى منظورك. دون إعداد يدوي. عدّل ما شئت لاحقًا.',
  ...
  'vs.steal.pastePh': 'الصق 3–10 منشورات أو تغريدات أو فقرات من النبرة التي تريد محاكاتها…',
  'vs.steal.analyzing': 'جارٍ تحليل النبرة…',
  'vs.steal.buildBtn': 'ابنِ نبرة من هذا',
  ...
  'vs.comment.info': 'يستخدمها مولّد التعليقات في متتبّع المنشورات (للتعليق الواحد وللدفعات). مؤشّرات النبرة في الأعلى تحدّد أسلوب الكتابة، وهذه تحدّد هدف الردّ وطوله.',
  'vs.comment.tone': 'الأسلوب',
  'vs.tone.casual': 'عفوي',
  'vs.tone.formal': 'رسمي',
  'vs.tone.witty': 'ذكي',
  ...
  'vs.comment.footer': 'تُحفظ في كل ملف نبرة — وتطبيق نبرة محفوظة يستعيد أيضًا إعداداته الافتراضية للتعليق.',
  'vs.save.title': 'احفظ ملف النبرة',
  'vs.save.subtitle': 'احفظ النبرة الحالية باسم. أعِد تطبيقها في أي وقت من صفّ الملفات المحفوظة في الأعلى — أو من محرّك المحتوى ومولّد تعليقات متتبّع المنشورات.',
  ...
  'vs.save.heading': 'احفظ ملف النبرة الحالي',
  'vs.save.namePh': 'اسم الملف (مثل: «نبرة أسبوع الإطلاق»، «B2B رصين»، «مؤسّس جريء»)',
  ...
  'vs.save.customVoice': 'نبرة مخصّصة',
  ...
  'ps.desc.new': 'يمكنك امتلاك مشروع نشط واحد فقط في المرّة، لذا يحلّ هذا محلّ مشروعك الحالي — تُمحى حساباته المتابَعة ومنشوراته ونبرته، ويبدأ المشروع الجديد من جديد. وتبقى مسجّل الدخول.',
  ...
  'ce.voice.title': 'النبرة',
  'ce.voice.variants': '{n} نسخة',
  'ce.voice.variantsPer': '{n} نسخة لكل منصّة',
  'ce.voice.adjust': 'اضبط النبرة',
  'ce.voice.forGen': 'النبرة المستخدَمة للتوليد',
  'ce.voice.change': 'تغيير',
  'ce.voice.builtin': 'نماذج جاهزة',
  'ce.voice.saved': 'نبراتك المحفوظة',
  'ce.voice.managedA': 'مزيج النبرة والمَطلع وعوامل الانتشار والخاتمة والمنظور يُضبَط في',
  ...
  'ce.dnaLoaded': 'حُمّلت هوية العلامة — ستُطبَّق النبرة تلقائيًا.',
  'ce.back': 'رجوع',
  ...
  'uc.voicePill.title': 'تُكتب تعليقات المتتبّع بهذه النبرة. انقر لتبديلها أو ضبطها.',
  'uc.commentVoice': 'نبرة التعليقات',
  'uc.voiceForComments': 'النبرة المستخدَمة في التعليقات',
  'uc.savedVoices': 'نبراتك المحفوظة',
  'uc.noSavedVoices': 'لا نبرات محفوظة بعد',
  'uc.noSavedVoices.body.a': 'ابنِ نبرة واحفظها في',
  'uc.noSavedVoices.body.b': '، ثم اخترها هنا لتُكتب بها كل التعليقات.',
  'uc.voiceNote.a': 'تُكتب تعليقات المتتبّع بالنبرة المحفوظة التي اخترتها. أنشئ النبرات أو اضبطها في',
  'uc.voiceNote.b': '.',
  ...
  'uc.modal.voice': 'النبرة',
  'uc.modal.applied': 'النبرة التي تختارها هنا ستُستخدم في التوليد التالي.',
  'uc.modal.style': 'أسلوب التعليق',
  'uc.modal.styleSetIn': '— يُضبَط في استوديو النبرة',
  ...
  'uc.modal.changeHint.a': 'غيّر الأسلوب والهدف والطول أو زاويتك الثابتة مرّة واحدة في',
