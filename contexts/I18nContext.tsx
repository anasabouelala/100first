...
const ar: Dict = {
  ...
  'vs.comment.info': 'يعيد مولّد تعليقات متتبّع المنشورات استخدامها (فرديًا ودفعيًا). مؤشّرات النبرة أعلاه تُشكّل كيفية كتابتك؛ وهذه تُشكّل نيّة الردّ وحدّ طوله.',
  ...
  'ce.voice.managedA': 'مزيج النبرة والمَطلع وفيزياء الانتشار والخاتمة والمنظور تُدار في',
  'ce.voice.managedB': 'وتنطبق التغييرات هناك على التوليد التالي تلقائيًا.',
  'ce.cta.title': 'دعوة إلى إجراء',
  'ce.cta.subtitle': 'مقدار الإلحاح في النهاية.',
