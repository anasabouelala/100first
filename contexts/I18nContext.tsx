...
const ar: Dict = {
  ...
  'ce.voice.title': 'الصوت',
  'ce.voice.variants': '{n} نسخة',
  'ce.voice.variantsPer': '{n} نسخة لكل منصّة',
  'ce.voice.adjust': 'اضبط الصوت',
  'ce.voice.forGen': 'الصوت المستخدَم للتوليد',
  'ce.voice.change': 'تغيير',
  'ce.voice.builtin': 'نماذج جاهزة',
  'ce.voice.saved': 'أصواتك المحفوظة',
  'ce.voice.managedA': 'مزيج الصوت والمَطلع وفيزياء الانتشار والخاتمة والمنظور تُدار في',
  ...
  'ce.dnaLoaded': 'حُمّلت هوية العلامة — سيُطبَّق الصوت تلقائيًا.',
  'ce.back': 'رجوع',
