...
const ar: Dict = {
  ...
  // Voice Studio
  'vs.lang.title': 'لغة المخرجات واللهجة',
  'vs.lang.sub': 'تُطبَّق على كل منشور وردّ ورسالة يُولَّدون.',
  'vs.voices': 'الأصوات',
  'vs.noVoices': 'لا أصوات محفوظة بعد — اضبط المؤشّرات أدناه واحفظ صوتًا في الأسفل.',
  'vs.newVoice': 'صوت جديد',
  'vs.steal.title': 'انسخ صوتًا',
  'vs.steal.subtitle': 'أتمتة بنقرة واحدة — أدرِج معرّفًا أو الصق كتابةً، ويبني الذكاء الاصطناعي الملف كاملًا أدناه.',
  'vs.steal.info': 'يستنسخ المحرّك إيقاعهم وبنيتهم، لا أفكارهم — تبقى مواضيعك ملكك.',
  'vs.steal.badge': 'أتمتة بنقرة واحدة',
  'vs.steal.body': 'أدرِج معرّف X / Twitter — يفتح الوكيل ملفهم، ويقرأ أحدث تغريداتهم الأصلية، ويبني الذكاء الاصطناعي تلقائيًا ملف صوتك كاملًا أدناه: مؤشّرات السمات السبع، والإيقاع، وصيغة المَطلع، والمضخّمات، والخاتمة، وحتى منظورك. دون إعداد يدوي. عدّل ما شئت لاحقًا.',
  ...
  'vs.steal.pastePh': 'الصق 3–10 منشورات أو تغريدات أو فقرات من الصوت الذي تريد محاكاته…',
  'vs.steal.analyzing': 'جارٍ تحليل الصوت…',
  'vs.steal.buildBtn': 'ابنِ صوتًا من هذا',
  'vs.comment.title': 'إعدادات التعليق الافتراضية',
  'vs.comment.subtitle': 'كيف يجب أن تُقرأ ردودك — اضبطها مرّة، فيرثها كل تعليق يُولَّد. لا حاجة لإعادة الضبط لكل منشور.',
  'vs.comment.info': 'يعيد مولّد تعليقات متتبّع المنشورات استخدامها (فرديًا ودفعيًا). مؤشّرات الصوت أعلاه تُشكّل كيفية كتابتك؛ وهذه تُشكّل نيّة الردّ وحدّ طوله.',
  'vs.comment.tone': 'النبرة',
  'vs.tone.casual': 'عفوية',
  'vs.tone.formal': 'رسمية',
  'vs.tone.witty': 'ذكية',
  ...
  'vs.comment.footer': 'تُحفظ في كل ملف صوتي — وتطبيق صوت محفوظ يستعيد أيضًا إعداداته الافتراضية للتعليق.',
  'vs.save.title': 'احفظ الملف الصوتي',
  'vs.save.subtitle': 'احفظ الصوت الحالي باسم. أعِد تطبيقه في أي وقت من صفّ الملفات المحفوظة في الأعلى — أو من محرّك المحتوى ومولّد تعليقات متتبّع المنشورات.',
  'vs.save.info': 'يحفظ كل شيء: محاور السمات السبع، والإيقاع، والمَطلع، والمضخّمات، والخاتمة، ومنظورك. يمكن تطبيق كل ملف محفوظ بنقرة واحدة في أي مكان يولّد محتوى.',
  'vs.save.heading': 'احفظ الملف الصوتي الحالي',
  'vs.save.namePh': 'اسم الملف (مثل: «صوت أسبوع الإطلاق»، «B2B رصين»، «مؤسّس جريء»)',
  ...
  'ps.desc.edit': 'تُطبَّق التغييرات على كل قسم — مكتشف الحسابات، ومراقب الموجز، ومحرّك المحتوى.',
  'ps.desc.new': 'يمكنك امتلاك مشروع نشط واحد فقط في المرّة، لذا يحلّ هذا محلّ مشروعك الحالي — تُمحى حساباته المتابَعة ومنشوراته وصوته، ويبدأ المشروع الجديد من جديد. وتبقى مسجّل الدخول.',
